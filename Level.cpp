...
void Level::load(std::string fileName)
{
	...
	// игровое пространство нужно чистить - потому как у каждого уровн€ оно своЄ
	if (area_.size() != 0)
	{
	...
	// при каждой новой загрузке уровн€ 
	// маску нужно чистить - потому как дл€ каждого уровн€ она сво€
	if (areaMask_.size() != 0)
	{
...
{
	// в буфер складываютс€ все символы, включа€ переход
	// на новую строку (\n) поэтому width_ + 1
